...
<?php include('navbar_dasboard.php'); ?>
    <div class="container">
		<div class="margin-top">
			<div class="row">
				...
				<div class="alert alert-info">Select Date of Appointment</div>
	...
	/* 	echo $count; */
		...
		<button name="yes" class="btn btn-success"><i class="icon-check icon-small"></i>&nbsp;Yes</button> &nbsp;  <a href="dasboard.php" class="btn"><i class="icon-remove"></i>&nbsp;No</a>
		</form>
    ...
    <div class="control-group">
    <label class="control-label" for="inputPassword">House Type</label>
    <div class="controls">
    ...
    <div class="control-group">
    <div class="controls">
    <button type="submit" name="sub" class="btn btn-info"><i class="icon-check icon-small"></i>&nbsp;Submit</button>
    </div>
    </div>
    </form>
