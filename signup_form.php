...
<form method="post">	
	...
	<div class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input name="age" class="span1" type="number" min="0" value="<?php if (isset($_POST['submit'])){echo $age;} ?>" placeholder="Age" required>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				<button name="submit" type="submit" id="submitBtn" disabled class="btn btn-info"><i class="icon-signin icon-large"></i>&nbsp;Sign Up</button>
			</div>
		</div>
    </div>
</div>
	...
	<div class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" for="inputCaptcha">Verify Captcha</label>
			<div class="controls">
				<div class="g-recaptcha" name="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6LfFH3ceAAAAAE6vJPy0EHaXySn2GYOSKSggeTDK"></div
			</div>
		</div>
